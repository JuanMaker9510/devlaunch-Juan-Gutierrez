...
El objetivo es obtener el numerador y el denominador resultantes de estas operqaciones.

Ademas, implementaras metodos correspondientes para cada operacio, devolviendo un objeto
resultante con el numerador y denominador calculados.

Dando la posibilidad de operar estas fracciones de 2 formas distitnas, tanto de funciones aparte
del objeto como incluidos como parte de su funcional dentro del objeto mismo.

const fraction1 = createFraction (3, 4)
const fraction2 = createFractions(2, 3)
...
const createFractionWithFunctions = (numerator: number, denominator: number): FractionWithOperators => {
